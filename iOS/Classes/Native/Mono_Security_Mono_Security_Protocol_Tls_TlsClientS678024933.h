...
struct  TlsClientSettings_t678024933_0  : public Object_t
{
	...
	X509CertificateCollection_t1761069182_0 * ___certificates_1;
	...
	X509Certificate_t_1468785580_0 * ___clientCertificate_2;
	// Mono.Security.Cryptography.RSAManaged Mono.Security.Protocol.Tls.TlsClientSettings::certificateRSA
	RSAManaged_t_1901935946_0 * ___certificateRSA_3;
};
