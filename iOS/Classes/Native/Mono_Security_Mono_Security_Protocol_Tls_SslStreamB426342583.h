...
struct  SslStreamBase_t426342583_0  : public Stream_t_500356931_0
{
	...
	RecordProtocol_t1347956653_0 * ___protocol_6;
	...
	ManualResetEvent_t_1294467456_0 * ___negotiationComplete_13;
	// System.Byte[] Mono.Security.Protocol.Tls.SslStreamBase::recbuf
	ByteU5BU5D_t1362406281_0* ___recbuf_14;
	// System.IO.MemoryStream Mono.Security.Protocol.Tls.SslStreamBase::recordStream
	MemoryStream_t_55945486_0 * ___recordStream_15;
};
struct SslStreamBase_t426342583_0_StaticFields{
	// System.Threading.ManualResetEvent Mono.Security.Protocol.Tls.SslStreamBase::record_processing
	ManualResetEvent_t_1294467456_0 * ___record_processing_2;
};
